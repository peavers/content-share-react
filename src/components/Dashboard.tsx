                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="text-lg font-medium text-gray-900">Manage your organizations</dd>
                    </dl>
                  </div>
                </div>
                <div className="mt-3">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Video Upload</dt>
                      <dd className="text-lg font-medium text-gray-900">Upload and manage videos</dd>
                    </dl>
                  </div>
                </div>
                <div className="mt-3">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="text-lg font-medium text-gray-900">Browse your videos</dd>
                    </dl>
                  </div>
                </div>
                <div className="mt-3">
