...
const AdminFAB: React.FC = () => {
  ...
  const canManageOrg = isPlatformAdmin || hasPermissionInCurrentWorkspace('manage_org');
  ...
  const showAdminFAB = canManageTags || canManageUploads || canInviteMembers || canManageOrg || hasViewAdmin || isPlatformAdmin;
