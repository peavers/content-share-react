...
export function CreateOrganizationModal({ isOpen, onClose, onSuccess }: CreateOrganizationModalProps) {
  ...
  return (
    <div className="modal modal-open">
      <div className="modal-box p-0 overflow-hidden" style={{ width: '85vw', maxWidth: '85vw', height: '85vh', maxHeight: '85vh' }}>
        {/* Header */}
        <div className="bg-gradient-to-r from-primary to-secondary p-6 text-primary-content">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-base-content/80 text-sm">Set up your organization and invite your team</p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="flex-1 p-8 overflow-y-auto bg-base-50">
            <div className="max-w-2xl">
              <div className="flex justify-between items-center mb-6">
                ...
                <span className="badge badge-lg">{inviteList.filter(i => i.email.trim()).length} Invited</span>
              </div>
              ...
              <div className="space-y-4">
                {inviteList.length > 0 ? (
                  ...
                  <div className="text-center py-16 border-2 border-dashed border-base-300 rounded-lg bg-base-100">
                    ...
                    <p className="text-sm text-base-content/40">Click the button below to start inviting your team</p>
                  </div>
                )}
